...
export class A11yPrefsElement extends HTMLElement {
  ...
  get #config(): A11yPrefsConfig {
    ...
    return {
      ...
      ...(read("radius-top-left") && { radiusTopLeft: read("radius-top-left") }),
      ...(read("radius-top-right") && { radiusTopRight: read("radius-top-right") }),
      ...(read("radius-bottom-right") && { radiusBottomRight: read("radius-bottom-right") }),
      ...(read("radius-bottom-left") && { radiusBottomLeft: read("radius-bottom-left") }),
  ...
  #render(): void {
    ...
    const custom: Record<string, string | number | undefined> = {
      ...
      "--a11y-corner-top-left": config.radiusTopLeft,
      "--a11y-corner-top-right": config.radiusTopRight,
      "--a11y-corner-bottom-right": config.radiusBottomRight,
      "--a11y-corner-bottom-left": config.radiusBottomLeft,
