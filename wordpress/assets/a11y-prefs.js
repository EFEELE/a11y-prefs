...
`;var T="a11y-prefs",pt={universal:'<circle cx="12" cy="12" r="9.2"/><circle cx="12" cy="7.1" r="1.35"/><path d="M6.9 10.1 12 11.1l5.1-1M12 11.1v3.2M12 14.3 9.7 19.6M12 14.3l2.3 5.3"/>',person:'<circle cx="12" cy="5" r="2.2"/><path d="M5 10.5 12 12l7-1.5M12 12v4M12 16l-3 6M12 16l3 6"/>',eye:'<path d="M2 12s3.8-6.5 10-6.5S22 12 22 12s-3.8 6.5-10 6.5S2 12 2 12Z"/><circle cx="12" cy="12" r="3"/>',wheelchair:'<circle cx="13" cy="4" r="2"/><path d="M11 8v5h5l3 7M8.5 11a6 6 0 1 0 7.6 8.4"/>'},zt='<path d="M6 6l12 12M18 6 6 18"/>',Tt='<path d="M3 12a9 9 0 1 0 3-6.7M3 4v4h4"/>',D={locale:"auto",fallbackLocale:E,position:"bottom-right",offset:"20px",shape:"circle",size:"md",accent:"#0b57d0",storageKey:"a11y-prefs"},q={};function ot(i){q={...q,...i}}var ut=!1;function Rt(){if(ut||document.getElementById("a11y-prefs-styles"))return;let i=document.createElement("style");i.id="a11y-prefs-styles",i.textContent=dt,document.head.append(i),ut=!0}function Pt(i){let e=i.trim().replace("#",""),t=e.length===3?e.replace(/./g,n=>n+n):e;if(!/^[0-9a-f]{6}$/i.test(t))return"#fff";let a=n=>{let c=parseInt(t.slice(n,n+2),16)/255;return c<=.03928?c/12.92:Math.pow((c+.055)/1.055,2.4)};return .2126*a(0)+.7152*a(2)+.0722*a(4)>.42?"#111827":"#fff"}var U=i=>`<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">${i}</svg>`,f,$,v,m,M,L,C,h,g,b,F,H,z,s,P,ht,gt,J,Z,Q,X,yt,tt,mt,vt,et,j,at,bt,I=class extends HTMLElement{constructor(){super();p(this,s);p(this,f);p(this,$);p(this,v);p(this,m);p(this,M);p(this,L);p(this,C,null);p(this,h,{});p(this,g);p(this,b,!1);p(this,F,!1);p(this,H,null);p(this,z,t=>l(this,s,yt).call(this,t.clientY));u(this,f,this.attachShadow({mode:"open"}))}static get observedAttributes(){return["locale","fallback-locale","messages","position","offset","offset-top","offset-right","offset-bottom","offset-left","radius-top-left","radius-top-right","radius-bottom-right","radius-bottom-left","shape","size","accent","accent-contrast","icon","label","features","statement-url","storage-key","z-index"]}connectedCallback(){Rt(),this.setAttribute("data-a11y-root",""),l(this,s,gt).call(this),l(this,s,tt).call(this);for(let t of S)l(this,s,Z).call(this,t)}disconnectedCallback(){document.removeEventListener("pointermove",o(this,z))}attributeChangedCallback(){o(this,F)&&l(this,s,tt).call(this)}open(){o(this,b)||(u(this,b,!0),u(this,H,o(this,f).activeElement??document.activeElement),o(this,m).hidden=!1,o(this,M).hidden=!1,o(this,v).setAttribute("aria-expanded","true"),o(this,m).querySelector(".icon-button")?.focus())}close(){if(!o(this,b))return;u(this,b,!1),o(this,m).hidden=!0,o(this,M).hidden=!0,o(this,v).setAttribute("aria-expanded","false");let t=o(this,H);(t instanceof HTMLElement&&t!==this&&t.isConnected?t:o(this,v)).focus()}toggle(){o(this,b)?this.close():this.open()}getState(){return{...o(this,h)}}set(t,a){a===null?delete o(this,h)[t]:o(this,h)[t]=a,l(this,s,Z).call(this,t),l(this,s,J).call(this),l(this,s,j).call(this),this.dispatchEvent(new CustomEvent("a11y-prefs-change",{detail:{id:t,value:a,state:this.getState()},bubbles:!0,composed:!0}))}reset(){for(let t of S)delete o(this,h)[t],document.documentElement.removeAttribute(B(t));l(this,s,X).call(this),l(this,s,J).call(this),l(this,s,j).call(this),l(this,s,at).call(this,o(this,g).t("ui.didReset")),this.dispatchEvent(new CustomEvent("a11y-prefs-change",{detail:{state:{}},bubbles:!0,composed:!0}))}};f=new WeakMap,$=new WeakMap,v=new WeakMap,m=new WeakMap,M=new WeakMap,L=new WeakMap,C=new WeakMap,h=new WeakMap,g=new WeakMap,b=new WeakMap,F=new WeakMap,H=new WeakMap,z=new WeakMap,s=new WeakSet,P=function(){let t=c=>this.getAttribute(c)??void 0,a=t("features"),r=t("messages"),n;if(r)try{n={...q.messages,...JSON.parse(r)}}catch{}return{...D,...q,...n&&{messages:n},...t("locale")&&{locale:t("locale")},...t("fallback-locale")&&{fallbackLocale:t("fallback-locale")},...t("position")&&{position:t("position")},...t("offset")&&{offset:t("offset")},...t("offset-top")&&{offsetTop:t("offset-top")},...t("offset-right")&&{offsetRight:t("offset-right")},...t("offset-bottom")&&{offsetBottom:t("offset-bottom")},...t("offset-left")&&{offsetLeft:t("offset-left")},...t("radius-top-left")&&{radiusTopLeft:t("radius-top-left")},...t("radius-top-right")&&{radiusTopRight:t("radius-top-right")},...t("radius-bottom-right")&&{radiusBottomRight:t("radius-bottom-right")},...t("radius-bottom-left")&&{radiusBottomLeft:t("radius-bottom-left")},...t("shape")&&{shape:t("shape")},...t("size")&&{size:t("size")},...t("accent")&&{accent:t("accent")},...t("accent-contrast")&&{accentContrast:t("accent-contrast")},...t("icon")&&{icon:t("icon")},...t("label")&&{label:t("label")},...t("statement-url")&&{statementUrl:t("statement-url")},...t("storage-key")&&{storageKey:t("storage-key")},...t("z-index")&&{zIndex:Number(t("z-index"))},...a&&{features:a.split(",").map(c=>c.trim()).filter(c=>S.includes(c))}}},ht=function(){let t=o(this,s,P).features;return t?.length?t:[...S]},gt=function(){try{let t=localStorage.getItem(o(this,s,P).storageKey??D.storageKey);t&&u(this,h,JSON.parse(t))}catch{}},J=function(){try{localStorage.setItem(o(this,s,P).storageKey??D.storageKey,JSON.stringify(o(this,h)))}catch{}},Z=function(t){let a=o(this,h)[t],r=document.documentElement;a===void 0?r.removeAttribute(B(t)):r.setAttribute(B(t),a),t==="readingHelp"&&l(this,s,Q).call(this)},Q=function(){let t=o(this,h).readingHelp;if(l(this,s,X).call(this),!t)return;let a=document.createElement("div");a.className=t==="mask"?"mask":"guide",a.style.setProperty("--top","45vh"),a.style.setProperty("--bottom","55vh"),t==="guide"&&(a.style.top="50vh"),o(this,$).append(a),u(this,C,a),document.addEventListener("pointermove",o(this,z),{passive:!0})},X=function(){document.removeEventListener("pointermove",o(this,z)),o(this,C)?.remove(),u(this,C,null)},yt=function(t){let a=o(this,C);a&&(o(this,h).readingHelp==="mask"?(a.style.setProperty("--top",`${Math.max(0,t-60)}px`),a.style.setProperty("--bottom",`${t+60}px`)):a.style.top=`${t}px`)},tt=function(){let t=o(this,s,P);u(this,g,ct(t.locale,t.fallbackLocale??E,t.messages));let a=o(this,g).t,r=t.icon??"universal",n=r in pt?pt[r]:String(r),c=t.label??a("ui.open"),x=t.accent??D.accent,y=t.accentContrast??Pt(x),k={"--a11y-accent":x,"--a11y-on-accent":y,"--a11y-offset":t.offset,"--a11y-offset-top":t.offsetTop,"--a11y-offset-right":t.offsetRight,"--a11y-offset-bottom":t.offsetBottom,"--a11y-offset-left":t.offsetLeft,"--a11y-corner-top-left":t.radiusTopLeft,"--a11y-corner-top-right":t.radiusTopRight,"--a11y-corner-bottom-right":t.radiusBottomRight,"--a11y-corner-bottom-left":t.radiusBottomLeft,"--a11y-z":t.zIndex},A=Object.entries(k).filter(([,w])=>w!==void 0&&w!=="").map(([w,_])=>`${w}:${_}`).join(";");o(this,f).innerHTML=`
      <style>${ft}</style>
      <div class="root"
           data-pos="${t.position}"
           data-shape="${t.shape}"
      ...
      </div>`,u(this,$,o(this,f).querySelector(".root")),u(this,v,o(this,f).querySelector(".launcher")),u(this,m,o(this,f).querySelector(".panel")),u(this,M,o(this,f).querySelector(".backdrop")),u(this,L,o(this,f).querySelector(".sr-only")),o(this,v).addEventListener("click",()=>this.toggle()),o(this,M).addEventListener("click",()=>this.close()),o(this,f).querySelector(".dismiss").addEventListener("click",()=>this.close()),o(this,f).querySelector(".reset").addEventListener("click",()=>this.reset()),o(this,m).addEventListener("keydown",w=>l(this,s,bt).call(this,w)),l(this,s,mt).call(this),u(this,F,!0),l(this,s,j).call(this),l(this,s,Q).call(this),o(this,b)&&(o(this,m).hidden=!1,o(this,M).hidden=!1,o(this,v).setAttribute("aria-expanded","true"))},mt=function(){let t=o(this,f).querySelector(".grid");t.replaceChildren();for(let a of o(this,s,ht)){let r=R(a);if(!r)continue;let n=document.createElement("button");n.type="button",n.className="card",n.dataset.id=a,n.innerHTML=U(r.icon)+`<span class="name">${o(this,g).t(`feature.${a}`)}</span>`+(r.kind==="step"?`<span class="pips">${r.options.map(()=>"<i></i>").join("")}</span>`:"")+'<span class="value"></span>',r.kind==="toggle"&&n.setAttribute("aria-pressed","false"),n.addEventListener("click",()=>l(this,s,vt).call(this,a)),t.append(n)}},vt=function(t){let a=R(t);if(!a)return;let r=o(this,h)[t],n=r?a.options.indexOf(r):-1;this.set(t,a.options[n+1]??null);let c=l(this,s,et).call(this,t)||o(this,g).t("ui.off");l(this,s,at).call(this,`${o(this,g).t(`feature.${t}`)}: ${c}`)},et=function(t){let a=R(t),r=o(this,h)[t];return!a||!r?"":a.kind==="toggle"?o(this,g).t("ui.on"):a.kind==="step"?o(this,g).t("ui.level",{n:a.options.indexOf(r)+1,max:a.options.length}):o(this,g).t(`option.${t}.${r}`)},j=function(){for(let t of o(this,f).querySelectorAll(".card")){let a=t.dataset.id,r=R(a);if(!r)continue;let n=o(this,h)[a],c=n!==void 0;r.kind==="toggle"?t.setAttribute("aria-pressed",String(c)):t.dataset.active=String(c),t.querySelector(".value").textContent=l(this,s,et).call(this,a);let x=c?r.options.indexOf(n)+1:0;t.querySelectorAll(".pips i").forEach((y,k)=>y.classList.toggle("on",k<x))}},at=function(t){o(this,L).textContent="",setTimeout(()=>o(this,L).textContent=t,60)},bt=function(t){if(t.key==="Escape"){t.stopPropagation(),this.close();return}if(t.key!=="Tab")return;let a=[...o(this,m).querySelectorAll("button, a[href]")].filter(x=>!x.hasAttribute("disabled")),r=a[0],n=a[a.length-1];if(!r||!n)return;let c=o(this,f).activeElement;t.shiftKey&&c===r?(t.preventDefault(),n.focus()):!t.shiftKey&&c===n&&(t.preventDefault(),r.focus())};function K(){typeof customElements<"u"&&!customElements.get(T)&&customElements.define(T,I)}function it(i={}){if(typeof window>"u")return null;ot(i),K();let e=document.querySelector(T);if(e)return e;let t=document.createElement(T);return(i.container??document.body).append(t),t}var xt=document.currentScript;function It(i){if(!i)return{};let e=i.dataset,t={};if(e.locale&&(t.locale=e.locale),e.fallbackLocale&&(t.fallbackLocale=e.fallbackLocale),e.position&&(t.position=e.position),e.offset&&(t.offset=e.offset),e.offsetTop&&(t.offsetTop=e.offsetTop),e.offsetRight&&(t.offsetRight=e.offsetRight),e.offsetBottom&&(t.offsetBottom=e.offsetBottom),e.offsetLeft&&(t.offsetLeft=e.offsetLeft),e.radiusTopLeft&&(t.radiusTopLeft=e.radiusTopLeft),e.radiusTopRight&&(t.radiusTopRight=e.radiusTopRight),e.radiusBottomRight&&(t.radiusBottomRight=e.radiusBottomRight),e.radiusBottomLeft&&(t.radiusBottomLeft=e.radiusBottomLeft),e.shape&&(t.shape=e.shape),e.size&&(t.size=e.size),e.accent&&(t.accent=e.accent),e.accentContrast&&(t.accentContrast=e.accentContrast),e.icon&&(t.icon=e.icon),e.label&&(t.label=e.label),e.statementUrl&&(t.statementUrl=e.statementUrl),e.storageKey&&(t.storageKey=e.storageKey),e.zIndex&&(t.zIndex=Number(e.zIndex)),e.features&&(t.features=e.features.split(",").map(a=>a.trim())),e.messages)try{t.messages=JSON.parse(e.messages)}catch{}return t}var $t={...window.a11yPrefsConfig,...It(xt)};K();xt?.dataset.auto!=="false"&&rt(()=>it($t));return Et(Ft);})();
