...
class A11y_Prefs_Frontend {
	...
	private function config_attributes() {
		...
		$attributes = array(
			...
			'offset-top'    => $options['offset_top'],
			'offset-right'  => $options['offset_right'],
			'offset-bottom' => $options['offset_bottom'],
			'offset-left'   => $options['offset_left'],
			'radius-top-left'     => $options['radius_top_left'],
			'radius-top-right'    => $options['radius_top_right'],
			'radius-bottom-right' => $options['radius_bottom_right'],
			'radius-bottom-left'  => $options['radius_bottom_left'],
